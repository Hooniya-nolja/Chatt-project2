          ...
          >
            <div key={index} className="oneclass_container">
              <div className="oneclass_keyword_container">
                <div className="oneclass_keyword" id="type">
                  방문
                </div>
                <div className="oneclass_keyword" id="hashtag">
                  #필라테스
                </div>
              </div>
              <div className="oneclass_description">{data.name}</div>
              <div className="oneclass_trainer">
                <img
                  className="oneclass_trainer_img"
                  src={data.teacher.image}
                />
                <div className="oneclass_trainer_name">
                  {data.teacher.name} 트레이너
                </div>
              </div>
            </div>
          </Link>
